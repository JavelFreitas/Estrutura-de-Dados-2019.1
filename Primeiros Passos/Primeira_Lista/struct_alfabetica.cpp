...
int main()// essa versão do código é de interação única, existe uma versão que disponibiliza multiplas interações para testar mais rapidamente
{
    Pessoa p1;
    Pessoa p2;
    Pessoa p3;
